...
public class NuageToxique extends Objet implements Deplacable, Combattant {
    ...
    /**
     * cet attribut contient l'objet sur lequel est placé le nuage si il y en a
     * un cela permet à un nuage et un objet d'être au même endroit sur la map
     */
    private Objet objet;
     ...
     *
     * @param element ligne de la sauvegarde comportant les caractéristiques du
     * nuage à créer
     */
  ...
  */   
    ...
    /**
     * Méthode permettant au nuage d'attaquer une créature lorsqu'il la
     * rencontre en se déplaçant
     *
    ...
    public void combattre(Creature c) {
        ...
        if (r.nextInt(101) <= this.pourcentageAtt) {
            ...
            System.out.println("Le " + c.getClass().getSimpleName() + " a perdu " + this.getDegAtt() + " points de vie à "
                    + "cause d'un Nuage Toxique");
            System.out.println();
    ...
    /**
     * Ecris dans le fichier la ligne de sauvegarde correspondant au
     * NuageToxique
     *
     * @param writer
     * @throws IOException
