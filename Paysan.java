...
/**
 * Cette classe permet de représenter un personnage de type Paysan (sous-classe
 * de Personnage)
 *
 * @author Mathilde
 */
public class Paysan extends Personnage {
    ...
    /**
     * Constucteur de Paysan qui prend en parametre la valeur de tous les
     * attributs de cette classe et de ses super-classes
     *
     * @param nom
     * @param pV
     * @param ptM
    ...
    /**
     * Constructeur de Paysan qui construit un paysan en fonction des attributs
     * du paysan mis en paramètre
     *
     * @param p
     */
    ...
    /**
     * Constructeur de Paysan par défault qui initialise les attributs à des
     * valeurs choisies par défault
     */
    public Paysan() {
        super();
